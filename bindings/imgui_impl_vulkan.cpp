...
//  2016-10-18: Vulkan: Add location decorators & change to use structs as in/out in glsl, move embedded spv (produced with glslangValidator -x). Null the released resources.
