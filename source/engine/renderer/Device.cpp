...
namespace engine {
    ...
    void Device::flushCommandBuffer(vk::CommandBuffer commandBuffer, vk::Queue queue, bool free) const {
     ...
     engine::Buffer Device::createBuffer(vk::BufferUsageFlags usageFlags, vk::MemoryPropertyFlags memoryPropertyFlags,
    ...
    void Device::copyBuffer(engine::Buffer *src, engine::Buffer *dst, vk::Queue queue, vk::BufferCopy *copyRegion) const {
